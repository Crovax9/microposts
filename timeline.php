        ...
        <div class="container">
            <div class="row">
                <aside class="col-md-4">
                    <form method="POST" action="timelinedatabase.php" accept-charset="UTF-8">
                ...
                <?php
                    $content = TimelineContentSearchAll();
                ...
                ?>
                    <li>
                        <div class="media-body">
                            ...
                            <div>
                                <?php
                                    if($contents['userid'] == $userid = $_SESSION["userid"])
                                    {
                                ?>
